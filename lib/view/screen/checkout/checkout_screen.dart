          ...
          builder: (context, order, child) {
            ...
            return Row(
              ...
              Consumer<CouponProvider>(builder: (context, coupon, child) {
                double _couponDiscount = coupon.discount != null ? coupon
                    .discount : 0;
                return Text(
                  PriceConverter.convertPrice(context, (widget
                      .totalOrderAmount + widget.shippingFee + widget.tax -
                      _couponDiscount)),
                  style: titilliumSemiBold.copyWith(color: Theme
                      .of(context)
                      .highlightColor),
                );
              }),
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(backgroundColor: Theme
                            .of(context)
                            .highlightColor, shape: RoundedRectangleBorder(
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          ...
                          Expanded(child: Text(
                            Provider
                                .of<OrderProvider>(context)
                                .addressIndex == null ? getTranslated(
                        ...
                        children: [
                          ...
                          ConstrainedBox(
                            constraints: Provider
                                .of<CartProvider>(context, listen: false)
                                .cartList
                                .length > 0 ? BoxConstraints(
                                maxHeight: 90 * Provider
                                    .of<CartProvider>(context, listen: false)
                                    .cartList
                                    .length
                                    .toDouble()) : BoxConstraints(maxHeight: 0),
                        ...
                        return Column(
                            ...
                            children: [
                              ...
                              AmountWidget(title: getTranslated(
                                  'ORDER', context), amount: PriceConverter
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      _cod ? CustomCheckBox(
                          ...
                          index: 0) : SizedBox(),
                      _digitalPayment ? CustomCheckBox(
